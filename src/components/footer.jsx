...
const Footer = () =>{
    return(
        ...
        <div className="footer-h flex  justify-between w-screen items-center  bg-custom-old-grey p-16 max-h-[300px] ">
            <div className="left-side flex flex-col justify-center items-start mr-10">
                <img src={Logo} alt="Logo-Footer" className=""/>
                <h1 className="text-white mt-5 max-w-3xl text-sm font-light ">2022-2024, akan dilakukan pemindahan tahap awal ke Kawasan IKN, pembangunan infrastruktur utama seperti Istana Kepresidenan, Gedung MPR/DPR RI dan perumahan, juga meliputi pemindahan ASN tahap awal, serta pembangunan dan beroperasinya infrastruktur dasar untuk 500.000 penduduk tahap awal.</h1>
            </div>
            <div className="right-side flex flex-col text-white space-y-2 text-sm mr-20 transition duration-300">
        ...
        <div className="footer-b relative flex m-0 bg-slate-200 w-screen min-h-16 max-h-16 ">
            <div className="background flex ">
                <img src={Patern} alt="" className="w-full h-full object-cover"/>
                <img src={Patern} alt="" className="w-full h-full object-cover" />
            </div>
            <div className="overlay flex absolute inset-0 px-10 items-center justify-between space-x-2 bg- w-screen">
                <div className="text  flex pl-16 space-x-10 text-sm text-black">
